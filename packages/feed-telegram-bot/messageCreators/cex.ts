...
export function createMessage(options: Message, constants) {
    ...
    +   `${constants.mainLink} | ${constants.emoji} [${constants.type[0].toUpperCase() + constants.type.slice(1).toLowerCase()}](${constants.pair ? constants.tradeLink : constants.tradeLinks[options.vsSymbol]}) | 💥 [Powered by CERBY Token](https://t.me/CerbyToken)`
}